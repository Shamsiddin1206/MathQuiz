...
fun ResultScreenView(){
    ResultScreen(rememberNavController(), "medium", 20, 30)
}

@Composable
fun ResultScreen(navController: NavController, level:String, score:Int, questionsNumber: Int){
    ...
    Box(
        ...
        Row(Modifier.fillMaxSize(), verticalAlignment = Alignment.CenterVertically) {
            Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                Text(text = text, fontSize = 20.sp, textAlign = TextAlign.Center, modifier = Modifier.padding(10.dp))
                Image(
